package com.upidea.upideamc.ASM;
...
import com.upidea.upideamc.UpideaMcASMLoadingPlugin;
...
{
	public static final Logger LOG = LogManager.getLogger("UpideaMineCraft ASM");
	...
	{
		if(UpideaMcASMLoadingPlugin.runtimeDeobf)
		{
