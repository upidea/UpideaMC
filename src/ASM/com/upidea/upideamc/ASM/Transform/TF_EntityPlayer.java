package com.upidea.upideamc.ASM.Transform;

import java.util.ArrayList;
import java.util.List;

import com.upidea.upideamc.ASM.ClassTransformer;
...
public class TF_EntityPlayer extends ClassTransformer
{
	...
	public TF_EntityPlayer()
	{
		...
		list.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "com/upidea/upideamc/ServerOverrides","canPlayerMove","(Lnet/minecraft/entity/EntityLivingBase;)Z"));
