package com.upidea.upideamc.GUI;
...
import com.upidea.upideamc.Reference;
import com.upidea.upideamc.Core.UpideaMc_Core;
//import com.upidea.upideamc.Core.TFC_Textures;
//import com.upidea.upideamc.Core.TFC_Time;
import com.upidea.upideamc.Core.Player.PlayerInventory;
//import com.upidea.upideamc.Food.ItemMeal;
//import com.upidea.upideamc.Food.TFCPotion;
//import com.upidea.upideamc.api.Food;
//import com.upidea.upideamc.api.Constant.Global;
//import com.upidea.upideamc.api.Interfaces.IFood;
//import com.upidea.upideamc.api.Tools.IKnife;

public class UpideaMcGuiInventory extends InventoryEffectRenderer
{
	private float xSizeLow;
	private float ySizeLow;
	private boolean hasEffect;
	protected static final ResourceLocation UPPER_TEXTURE = new ResourceLocation(Reference.MOD_ID+":textures/gui/gui_inventory.png");
	...
	public UpideaMcGuiInventory(EntityPlayer player)
	{
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		if(player.getEntityData().hasKey("craftingTable"))
            UpideaMc_Core.bindTexture(UPPER_TEXTURE);
		else
            UpideaMc_Core.bindTexture(UPPER_TEXTURE_2X2);
		int k = this.guiLeft;
		int l = this.guiTop;
...
//		else
		...
		{
            UpideaMineCraft.LOG.info("进入　里面　　");
...
//				0, 86, 25, 20, UpideaMc_Core.translate("gui.Inventory.Inventory"), TFC_Textures.guiInventory));
//		buttonList.add(new GuiInventoryButton(1, guiLeft+176, guiTop + 22, 25, 20,
//				0, 86, 25, 20, UpideaMc_Core.translate("gui.Inventory.Skills"), TFC_Textures.guiSkills));
//		buttonList.add(new GuiInventoryButton(2, guiLeft+176, guiTop + 41, 25, 20,
//				0, 86, 25, 20, UpideaMc_Core.translate("gui.Calendar.Calendar"), TFC_Textures.guiCalendar));
//		buttonList.add(new GuiInventoryButton(3, guiLeft+176, guiTop + 60, 25, 20,
//				0, 86, 25, 20, UpideaMc_Core.translate("gui.Inventory.Health"), TFC_Textures.guiHealth));
	}
...
//			Minecraft.getMinecraft().displayGuiScreen(new GuiHealth(player));
	...
	public void drawScreen(int par1, int par2, float par3)
	{
        ...
        // UpideaMineCraft.LOG.info("进入 drawScreen : " + this.inventorySlots.inventorySlots.size());
...
//						Potion.potionTypes[var8.getPotionID()];
				...
				GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
                UpideaMc_Core.bindTexture(EFFECTS_TEXTURE);
				...
				String var12 = UpideaMc_Core.translate(var9.getName());
