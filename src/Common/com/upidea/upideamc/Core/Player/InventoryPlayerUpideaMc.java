package com.upidea.upideamc.Core.Player;
...
public class InventoryPlayerUpideaMc extends InventoryPlayer {

	public ItemStack[] extraEquipInventory = new ItemStack[UpideaMc_Core.getExtraEquipInventorySize()];

	public InventoryPlayerUpideaMc(EntityPlayer par1EntityPlayer) {
	...
	public void readFromNBT(NBTTagList par1NBTTagList)
	{
		...
		this.extraEquipInventory = new ItemStack[UpideaMc_Core.getExtraEquipInventorySize()];
	...
	{
		if(par1InventoryPlayer instanceof InventoryPlayerUpideaMc){
			this.copyInventoryTFC((InventoryPlayerUpideaMc)par1InventoryPlayer);
		}
		else{
	...
	public void copyInventoryTFC(InventoryPlayerUpideaMc par1InventoryPlayer)
	{
		int i;
