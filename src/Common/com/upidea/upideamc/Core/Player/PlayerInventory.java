...
//import com.upidea.upideamc.Containers.Slots.SlotExtraEquipable;
//import com.upidea.upideamc.Containers.Slots.SlotForShowOnly;
...
//			else
	...
	{
		UpideaMc_Core.bindTexture(invTexture);
	...
	public static InventoryPlayerUpideaMc getInventory(EntityPlayer p)
	{
		return (InventoryPlayerUpideaMc)p.inventory;
	}
